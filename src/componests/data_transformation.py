...
class DataTransformation:
    ...
    def get_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical imputing and scaling is completed")
            
            logging.info("Categorical converting into numerical and scaling is completed")
            
            preprocessor = ColumnTransformer(
                [
                    ("num_pipeline",num_pipeling,numerical_columns),
